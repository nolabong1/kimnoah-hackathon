...
def render_help_dialog() -> None:
    ...
    st.info(
        ...
        "순서로 시작하세요. 7일을 마치면 **주간 학습 회고 → 다음 7일 "
        "계획**으로 자연스럽게 이어집니다.",
    ...
    with start_tab:
        ...
        step_rows = (
            ...
            (
                (
                    "5. 주간 학습 회고",
                    "7일 계획을 모두 마치면 완료 안내의 **회고하고 다음 "
                    "계획 이어가기**를 눌러 기록과 나의 회고를 정리하세요.",
                ),
                (
                    "6. 다음 7일 이어가기",
...
- **7일 학습을 마친 다음에는 무엇을 하나요**: 완료 안내의 ‘회고하고 다음 계획 이어가기’를 누르거나 **주간 학습 회고**에서 기록 확인 → AI 회고 → 다음 7일 계획 순서로 진행하세요.
                """
            )
