...
from views.quiz_result_ui import (
    get_choice_diagnostic as _get_choice_diagnostic,
    get_display_questions as _get_display_questions,
    get_question_source_support as _get_question_source_support,
    group_mastery_changes as _group_mastery_changes,
    render_quiz_result as _render_quiz_result,
)
